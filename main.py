...
matrix1 = [[I(2.48, 3.12), I(0.23, 3.23)],
           [I(3.11, 8.12), I(0.2, 4.7)]]

matrix2 = [[I(0.12, 2.02), I(0.23, 0.01)],
           [I(2.81, 5.12), I(0.2, 1.7)]]

matrix1 = [[I(3.12, 2.48), I(0.23, 3.23), I(11.2, 7.23)],
           [I(3.11, 8.12), I(0.2, 4.7), I(9.2, 17.2)],
           [I(4.6, 8.6), I(2.43, 1.12), I(1.2, 3.2)]]

matrix2 = [[I(0.12, 2.02), I(0.23, 0.01), I(1.2, 3.23)],
           [I(2.81, 5.12), I(0.2, 1.7), I(9.2, 10.2)],
           [I(4.6, 3.6), I(2.43, 3.12), I(1.2, 3.2)]]
...
res = I.matrix_mult(I.matrix_mult(A, B), C)
for i in range(len(res)):
    for j in range(len(res)):
        res[i][j].show_interval()

matr_gaus = [[I(1, 1.132), I(-3), I(-1)],
             [I(2), I(-1), I(2.897, 3)],
             [I(7), I(7), I(3)]]
matr_b = [I(-5), I(0.98, 1), I(2, 3)]

mtr = [[I(2, 3.22), I(1.1, 3.2)],
       [I(1.2, 2), I(2, 2.12)]]

mtr_b = [I(1.1, 2.6), I(2, 2.13)]

res = I.gauss(matr_gaus, matr_b, 3)
for i in range(len(res)):
    res[i].show_interval()

print('========')
res = I.gauss(mtr, mtr_b, 2)
for i in range(len(res)):
    res[i].show_interval()
...
print()
print('Lol:')
res = I.log(I(5.678, 8.002), 2.72)
res.show_interval()

inter = I(5.678, 8.002)
#TODO не работает корень
res = I.power(inter, 1/2)
res.show_interval()
